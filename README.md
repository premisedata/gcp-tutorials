...
**006 - Service Account Key Rotater** [[ Source ](https://github.com/premisedata/gcp-tutorials/006-service-account-key-rotater)] [Written]()] - A seamless way to set up Service Account Key rotation within Github Secrets and Cloud Storage